...
import { searchingRoomsTypes } from "../types/types.js";

export const searching = tryCatchFunction(async (req: Request<{}, {}, searchingRoomsTypes>, res: Response, next: NextFunction) => {
